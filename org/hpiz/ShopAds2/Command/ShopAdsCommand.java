...
public class ShopAdsCommand extends ShopAds2 implements CommandExecutor {
    ...
    private void set(Player player, String[] args) {
        ...
        if(!shopHandler.shopExists(args[2])){
            message.error.noShopFound(player, args[2]);
            return;
        }
        //ad set shop
        if (args.length == 2) {
    ...
    private void setGeneral(Player player, String[] args) {
        ...
        Shop shop = shopHandler.getShopByName(shopName);
        ...
        switch (action) {
            case 'a':
                ...
                break;
            case 'l':
                shopHandler.getShopByName(shopName).setLocation(player.getLocation());
                break;
            case 'n':
            ...
            case 'w':
                ...
                shopHandler.getShopByName(shopName).addWorldToAdvertiseIn(player.getWorld());
    ...
    private void setSpecific(Player player, String[] args) {
        ...
        switch (action) {
            case 'a':
                ...
                shopHandler.getShopByName(shopName).setAdvertisement(sb.toString());
            ...
            case 'l':
                ...
                break;
            case 'n':
                shopHandler.getShopByName(shopName).setShopName(args[3]);
                message.command.shopNameChanged(player, shopHandler.getShopByName(shopName), args[3]);
                break;
            case 'w':
